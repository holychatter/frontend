	...
	return (
		<React.Fragment>
			<div id='hcSidenavId' className='hc-sidenav' onMouseOver={OpenNav} onMouseOut={CloseNav}>
				...
				<Link to={"/" + language + "/" + GetStrLocalized(language, "gospelOfTheDayFolderName")}><img style={{marginLeft: 20}} width='20px' src={image_bible} alt="Bible" /><span className='hc-sidebar-text hc-sidebar-text-sub'><GetHtmlStrLocalized language={language} textId="gospelOfTheDay" /></span></Link>
